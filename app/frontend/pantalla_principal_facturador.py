...
from screens.pantalla_principal_facturador_ui import Ui_Form  # Importa la clase generada por Qt Designer
import sys
...
if __name__ == "__main__":
    ...
    window = PantallaPrincipalFacturador()  # Cambiar a la clase correcta
    window.show()
    sys.exit(app.exec_())
